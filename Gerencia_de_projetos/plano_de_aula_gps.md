...
| Aula 8: 16/04/2024 | Exercício realizado 2: Exercício realizado 2: Foram criadas no scriptcase as seguintes aplicações: Abas, blank, cadastros (consultas (grids) e formulários), controle, filtros, dashboard, gráficos, relatórios e módulos de segurança. Posteriormente foi feito a implantação da aplicação gerada no Apache do Laragon e configurado o ambiente de produção da aplicação final. |
| Aula 9: 23/04/2024 | Estrutura do projeto, FPA, SWOT, Project Canvas. TWIG, qdPM + ProjectLibre. Estrutura do projeto, TWIG, qdPM + ProjectLibre. Controle de versão, testes, qualidade, exercícios. Scrum. Jogo [TWIG](https://analytics.actionableagile.com/twig/index.html). Jogo [Design thinking](https://inova-game-46342.web.app/). [Exemplo de edital para contração de solução inovadora](https://portal.tcu.gov.br/lumis/portal/file/fileDownload.jsp?fileId=8A81881F8C46A4A3018E9A11A5384962&inline=1). |
