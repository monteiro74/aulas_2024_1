...
| Aula 8: 18/04/2024 | Conceitos de processo, modelagem visual, modelagem de processos, processos sob medida. Processo SCRUM, considerações sobre programação, considerações sobre banco de dados. Arquitetura de software.  |
